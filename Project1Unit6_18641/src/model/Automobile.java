...
public class Automobile implements Serializable {
    ...
    public synchronized void printChoice(ArrayList<Option> choice) {
        System.out.println("Hello, your choice option are:");
    ...
    public synchronized void setOptionChoice(OptionSet optionSet, String optionName) {
    ...
    public int getOptionSize(String optionSetName) {
        for(OptionSet optionSet : opset) {
            if(optionSet.getName().equals(optionSetName)) {
                return optionSet.getOptionSize();
                }
            }
        return 0;
    }
    
    public ArrayList<String> getOptionsName(int i) {
